      ...
      body: ListView(
        ...
        children: [
          ...
          Consumer<AppDataProvider>(
            builder: (context, provider, _) => FutureBuilder<List<BusShedule>>(
                ...
                if (snapshot.hasData){
                  ...
                  return Column(
                    ...
                    !.map((shedule) => ScheduleItemView(
                            shedule: shedule, date: departureDate, ))
                        .toList(),
                  );
                }
...
class ScheduleItemView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: ()=>Navigator.pushNamed(context, routeNameSeatPlanPage, arguments: [shedule,date]),
      child: Card(
        child: Column(
